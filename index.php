...
?>
		...
		<div class="center" style="font-family: Arial; background-color: var(--colorSecondaryBackground); color: var(--colorSecondaryText); border-radius: 8px; width: 15em; font-size: x-large; margin-top: 6em; padding: 1em;">
