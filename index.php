...
?>
		...
		<div class="center" style="font-family: Arial; background-color: orange; color: white; border-radius: 8px; width: 15em; font-size: x-large; margin-top: 6em; padding: 1em;">
