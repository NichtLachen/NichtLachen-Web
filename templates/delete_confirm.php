			<div>
				<div class="modal">
					<div class="modal-content error">
						...
						<a class="button success" href="<?php echo urldecode($from); ?>" onclick="return deleteConfirmClose(<?php echo $delid; ?>);">Nein</a> <a class="button error" href="<?php echo $delete; ?>">Ja</a>
					</div>
				</div>
			</div>
